...
newDat2 = newDat1(:,2:end);
[resid, residMat ,somComp, somTot, retorno]  = resi(esc, canais, ...
    newDat2(:,[1:(col-1),(col+1):end]), newTot,[1 1 1 1], perce1);
%legenda2 = {'res'; 'resM';'C';'H2O';'S3';'tot'};  
legenda = {'Res';'C'; 'H2O'; 'S3';'SiO2';'Tot'};
                                                             % modificar 
                                                             % essa linha
                                                             % posteriormente
                                                             % para que
